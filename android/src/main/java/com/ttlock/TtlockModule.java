...
public class TtlockModule extends NativeTtlockSpec {

    public static final String NAME = "Ttlock";
...
//    }
    ...
    @ReactMethod
    public void removeListeners(double countDouble) {
...
//                  Log.e("tag", "extendedBluetoothDevice:" + extendedBluetoothDevice.getName());
...
//                    Log.e("tag", "extendedBluetoothDevice 交互:" + extendedBluetoothDevice.getName());
                }
              }
    ...
    @ReactMethod
    public void controlLock(double controlAction, String lockData, Callback successCallback, Callback fail) {
  ...
  @ReactMethod
  public void recoverPasscode(String passcode, double passcodeType, double cycleType, double startDate, double endDate, String lockData, Callback successCallback, Callback fail) {
    if (TextUtils.isEmpty(passcode) || TextUtils.isEmpty(lockData)) {
      lockErrorCallback(LockError.DATA_FORMAT_ERROR, fail);
      return;
    }
    ...
    recoveryData.cycleType = (int) cycleType;
    recoveryData.keyboardPwdType = (int) passcodeType;
  ...
  public void recoverLockData(String recoveryDataJson, double recoveryType, String lockData, Callback successCallback, Callback fail) {
    ...
    @ReactMethod
    public void getLockConfig(double config, String lockData, Callback successCallback, Callback fail) {
      PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
        if (success) {
    ...
    @ReactMethod
    public void setLockConfig(double config, boolean isOn, String lockData, Callback successCallback, Callback fail) {
    ...
    @ReactMethod
    public void addPassageMode(double type, ReadableArray weekly, ReadableArray monthly, double startDate, double endDate, String lockData, Callback successCallback, Callback fail) {
      PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
        if (success) {
   ...
   */
  @ReactMethod
  public void setLockSoundVolume(double soundVolumeValue, String lockData, Callback successCallback, Callback fail) {
    PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
      if (success) {
        SoundVolume soundVolume = SoundVolume.OFF;
        switch ((int) soundVolumeValue) {
          case -1://On = -1,
          ...
          case 4:
          case 5:
            soundVolume = SoundVolume.getInstance((int) soundVolumeValue);
            break;
        }
...
//      Level_5 = 5
   ...
   */
  @ReactMethod
  public void setUnlockDirection(double direction, String lockData, Callback successCallback, Callback fail) {
    PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
      if (success) {
        TTLockClient.getDefault().setUnlockDirection(((int) direction) == 1 ? UnlockDirection.LEFT : UnlockDirection.RIGHT, lockData, new SetUnlockDirectionCallback() {
          @Override
...
//             Right = 2
  ...
  public void clearAllRemoteKey(String lockData, Callback successCallback, Callback fail) {
    ...
    @ReactMethod
    public void setDoorSensorAlertTime(double time, String lockData, Callback successCallback, Callback fail) {
        PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
            if (success) {
                TTLockClient.getDefault().setDoorSensorAlertTime((int) time, lockData, new SetDoorSensorAlertTimeCallback() {
                    @Override
  ...
  @ReactMethod
  public void getAccessoryElectricQuantity(double type, String mac, String lockData, Callback successCallback, Callback fail) {
    PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
      if (success) {
  ...
  @ReactMethod
  public void configWifiPowerSavingTime(ReadableArray days, double startDate, double endDate, String lockData, Callback successCallback, Callback fail) {
    PermissionUtils.doWithConnectPermission(getCurrentActivity(), success -> {
      if (success) {
        TTLockClient.getDefault().configWifiPowerSavingTimes(Utils.readableArray2IntList(days), (int) startDate, (int) endDate, lockData, new ConfigWifiPowerSavingTimesCallback() {
          @Override
...
//        }
    ...
    @ReactMethod
    public void supportFunction(double function, String lockData, Callback callback) {
